...
public class VerticleAdapter extends RecyclerView.Adapter<VerticleAdapter.ProgrammingViewHolder> {

    SportsData[] sportsData;
    Context context;

    public VerticleAdapter(SportsData[] sportsData, Context context) {
    ...
    public ProgrammingViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.list_item_layout_verticle, parent, false);
